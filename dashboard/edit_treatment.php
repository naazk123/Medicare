    ...
    <?php include "sidebar.php";?>
        ...
        <div class="main-panel">
            <div class="content-wrapper">
                ...
                //   $id=$_GET['id'];
                  $asd = mysqli_query($con,"select * from treatment where treatmentid='".$_GET['id']."'") or die (mysqli_error($con));
                  ...
                  <form class="forms-sample" method="POST" action="" id="">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control"  value="<?php echo $treatmenttype;?>" Name="name" required placeholder="Enter Name of Faculty">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputUsername1">Treatment Cost</label>
                      <input type="text" class="form-control" value="<?php echo $treatment_cost;?>" Name="cost" required placeholder="Enter the Department name">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputUsername1">Treatment Cost</label>
                      <input type="text" class="form-control" value="<?php echo $note;?>" Name="note" required placeholder="Enter the Department name">
                    </div>
                    <div class="form-group">
...
extract($_POST);
// echo "hello";
$query="UPDATE `treatment` SET `treatmenttype`='$name',
                                `treatment_cost`='$cost',
                                `note`='$note',
                                `status`='$status' 
                                WHERE `treatmentid`='".$_GET['id']."';";
