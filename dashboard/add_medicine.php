                ...
                <div class="row">
                  ...
                  <form class="forms-sample" method="POST" action="" id="myForm">
                    ...
                    <div class="form-group">
                      <label for="exampleInputUsername1">Medicine Name</label>
...
$query="INSERT INTO `medicine`(`medicinename`, `medicinecost`, `description`, `status`) VALUES ('$name','$cost','$note','$status')";
...
if($asd)
{
  ...
  echo " alert('Medicine Details Added Successfully');";
