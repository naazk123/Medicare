        ...
        <div class="main-panel">
            <div class="content-wrapper">
                <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">View Treatment Records</h4>
                            <div class="row">
                                <div class="col-12">
                                    <div class="table-responsive">
                                        <table id="order-listing" class="table table-striped table-bordered table-hover">
                                            <thead>
                                                <tr>
                                                    <th><h4>Action</h4></th>
                                                    <th><h4>Treatment Type</h4></th>
                                                    <th><h4>Treatment Cost</h4></th>
                                                    <th><h4>Note</h4></th>
                                                    <th><h4>Status</h4></th>
                                                </tr>
                                            </thead>
                                                ...
                                                if ($result = $con->query($select))
                                                {
                                                    while ($data = $result->fetch_assoc())
                                                    {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <a href="edit_treatment.php?id='.$data["treatmentid"].'"><i class="fas fa-edit " style="margin-right:3%;color: green" ></i></a>
                                                            <a href="delete_treatment.php?id='.$data["treatmentid"].'"><i class="fas fa-trash" style="color: red"></i></a>
                                                            </td>
