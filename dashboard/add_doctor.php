                ...
                <div class="row">
                  ...
                  <form class="forms-sample" method="POST" action="" id="myForm">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputname1" Name="name" required placeholder="Enter Name of Patient">
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputPassword1" Name="city" required placeholder="Enter name of city">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword1">Pincode</label>
                      <input type="text" class="form-control" id="exampleInputPassword1" Name="pincode" required placeholder="Enter Pincode">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword1">Mobile Number</label>
                      <input type="number" class="form-control" id="exampleInputPassword1" Name="mobileno" required placeholder="Enter mobile number">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputUsername1">Login Id</label>
                      <input type="text" class="form-control" id="exampleInputUsername1" Name="loginid" required placeholder="Enter Loginid">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="date" class="form-control" id="exampleInputPassword1" Name="add_date" required placeholder="Date">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword1">Admission Time</label>
                      <input type="time" class="form-control" id="exampleInputPassword1" Name="add_time" required placeholder="Time">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword1">Date Of Birth</label>
                      <input type="date" class="form-control" id="exampleInputPassword1" Name="dob" required placeholder="DOB">
                    </div>
...
$query="INSERT INTO `patient`(`patientname`, `admissiondate`, `admissiontime`, `address`, `mobileno`, `city`, `pincode`, `loginid`, `password`, `bloodgroup`, `gender`, `dob`, `status`) VALUES ('$name','$add_date','$add_time','$address','$mobileno','$city','$pincode','$loginid','$password','$blood_group','$gender','$dob','$status')";
...
if($asd)
{
  ...
  echo 'window.location.href = "view_doctor.php";';
  echo '</script>';
}  
else
{ 
