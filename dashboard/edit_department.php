    ...
    <?php include "sidebar.php";?>
        ...
        <div class="main-panel">
            <div class="content-wrapper">
                ...
                //   $id=$_GET['id'];
                  $asd = mysqli_query($con,"select * from department where departmentid='".$_GET['id']."'") or die (mysqli_error($con));
                  ...
                  <form class="forms-sample" method="POST" action="" id="">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control"  value="<?php echo $departmentname;?>" Name="name" required placeholder="Enter Name of Faculty">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputUsername1">Description</label>
                      <input type="text" class="form-control" value="<?php echo $description;?>" Name="desc" required placeholder="Enter the Department name">
                    </div>
                    <div class="form-group">
...
extract($_POST);
// echo "hello";
$query="UPDATE `department` SET `departmentname`='$name',
                                `description`='$desc',
                                `status`='$status' 
...
if($asd)
{
  ...
  echo "alert('Department Update Successfully');";
