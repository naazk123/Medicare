                ...
                <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-12">
                                <h4 class="card-title">Add New Appointment Record</h4>
                  ...
                  <form class="forms-sample" method="POST" action="" id="myForm">
                    ...
                    <div class="form-group">
                      <label for="exampleInputUsername1">Select Patient</label>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputUsername1" Name="type" required placeholder="Username">
                    </div>
                    <div class="form-group">
...
$query="INSERT INTO `admin`( `adminname`, `loginid`, `password`, `status`, `usertype`) VALUES ('$name','$username','$password','$status','$type')";
