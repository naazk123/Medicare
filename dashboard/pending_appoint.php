                                ...
                                <div class="col-12">
                                    <div class="table-responsive">
                                        <table id="order-listing" class="table table-striped table-bordered table-hover">
                                            ...
                                            <?php
                                                require 'db.php';
                                                $select = "select a.* , dp.departmentname, d.doctorname, p.patientname,p.mobileno,r.roomtype from appointment a,patient p,department dp,doctor d,room r where a.patientid=p.patientid and a.roomid=r.roomid and a.departmentid=dp.departmentid and a.doctorid=d.doctorid and a.status='Pending'";
                                                ...
                                                if ($result = $con->query($select))
                                                {
                                                    while ($data = $result->fetch_assoc())
                                                    {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <a href="delete_pending.php?id='.$data["appointmentid"].'"><i class="fas fa-trash" style="color: red"></i></a>
                                                            </td>
                                                            ...
                                                            <td > <h6 class="table_row_name">Date:</h6> '.$data["appointmentdate"].'<br><br>
                                                        ...
                                                        <?php 
                                                            ...
                                                            if(isset($_GET['delete_msg'])){
                                                                ...
                                                                echo 'window.location.href = "pending_appoint.php";';
                                                                echo '</script>';
