        ...
        <div class="main-panel">
            <div class="content-wrapper">
                <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">View Medicine Records</h4>
                            <div class="row">
                                <div class="col-12">
                                    <div class="table-responsive">
                                        <table id="order-listing" class="table table-striped table-bordered table-hover">
                                            <thead>
                                                <tr>
                                                    <th><h4>Action</h4></th>
                                                    <th><h4>Medicine Name</h4></th>
                                                    <th><h4>Medicine Cost</h4></th>
                                                    <th><h4>Medicine Description</h4></th>
                                                ...
                                                if ($result = $con->query($select))
                                                {
                                                    while ($data = $result->fetch_assoc())
                                                    {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <a href="edit_medicine.php?id='.$data["medicineid"].'"><i class="fas fa-edit " style="margin-right:3%;color: green" ></i></a>
                                                            <a href="delete_medicine.php?id='.$data["medicineid"].'"><i class="fas fa-trash" style="color: red"></i></a>
                                                            </td>

                                                            <td >'.$data["medicinename"].'</td>
                                                            <td >'.$data["medicinecost"].'</td>
                                                        ...
                                                        <?php 
                                                            ...
                                                            if(isset($_GET['delete_msg'])){
                                                                ...
                                                                echo "alert('Medicine details deleted Successfully');";
