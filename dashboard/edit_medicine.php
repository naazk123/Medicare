    ...
    <?php include "sidebar.php";?>
        ...
        <div class="main-panel">
            <div class="content-wrapper">
                ...
                //   $id=$_GET['id'];
                  $asd = mysqli_query($con,"select * from medicine where medicineid='".$_GET['id']."'") or die (mysqli_error($con));
                  ...
                  <form class="forms-sample" method="POST" action="" id="">
                    ...
                    <div class="form-group">
                      <label for="exampleInputUsername1">Name of Medicine</label>
                      <input type="text" class="form-control"  value="<?php echo $medicinename;?>" Name="name" required placeholder="Enter Name of Faculty">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputUsername1">Medicine Cost</label>
                      <input type="text" class="form-control" value="<?php echo $medicinecost;?>" Name="cost" required placeholder="Enter the Department name">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputUsername1">Description</label>
                      <input type="text" class="form-control" value="<?php echo $description;?>" Name="desc" required placeholder="Username">
                    </div>
                    
                    
                    <button type="submit" name="submit" class="btn btn-primary me-2">Update</button>
                    <a href="view_admin.php" class="btn btn-light">Cancel</a>
...
extract($_POST);
// echo "hello";
$query="UPDATE `medicine` SET `medicinename`='$name',
                                `medicinecost`='$cost',
                                `description`='$desc' 
                                WHERE `medicineid`='".$_GET['id']."';";
...
if($asd)
{
  ...
  echo "alert('Medicine Details Update Successfully');";
...
{ 
  ...
  echo 'window.location.href = "add_medicine.php";';
  echo '</script>';
}
