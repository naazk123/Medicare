    ...
    <?php include "sidebar.php";?>
        ...
        <div class="main-panel">
            <div class="content-wrapper">
                ...
                //   $id=$_GET['id'];
                  $asd = mysqli_query($con,"select * from admin where adminid='".$_GET['id']."'") or die (mysqli_error($con));
                  ...
                  <form class="forms-sample" method="POST" action="" id="">
                    ...
                    <div class="form-group">
                      <label for="exampleInputUsername1">Name of Admin</label>
                      <input type="text" class="form-control"  value="<?php echo $adminname;?>" Name="name" required placeholder="Enter Name of Faculty">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputUsername1">loginid</label>
...
extract($_POST);
// echo "hello";
$query="UPDATE `admin` SET `adminname`='$name',
                                `loginid`='$loginid',
                                `status`='$status' 
                                WHERE `adminid`='".$_GET['id']."';";
