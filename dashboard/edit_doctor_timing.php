    ...
    <?php include "sidebar.php";?>
        ...
        <div class="main-panel">
            <div class="content-wrapper">
                ...
                //   $id=$_GET['id'];
                  $asd = mysqli_query($con,"select * from doctor_timings where doctor_timings_id='".$_GET['id']."'") or die (mysqli_error($con));
                  ...
                  <form class="forms-sample" method="POST" action="" id="">
                    ...
                    <div class="form-group">
                      <label for="exampleInputUsername1">ID of Doctor</label>
                      <input type="text" class="form-control"  value="<?php echo $doctorid;?>" Name="d_id" required placeholder="Enter Name of Faculty">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputUsername1">Doctor Timing ID</label>
                      <input type="text" class="form-control" value="<?php echo $doctor_timings_id;?>" Name="loginid" required placeholder="Enter the Department name">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputUsername1">Start Time</label>
                      <input type="text" class="form-control"  value="<?php echo $start_time;?>" Name="s_time" required placeholder="Enter Name of Faculty">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputUsername1">End Time</label>
                      <input type="text" class="form-control"  value="<?php echo $end_time;?>" Name="e_time" required placeholder="Enter Name of Faculty">
                    </div>
                    <div class="form-group">
...
extract($_POST);
// echo "hello";
$query="UPDATE `doctor_timings` SET `doctorid`='$d_id',
                                `start_time`='$s_time',
                                `end_time`='$e_time',
                                `doctor_timings_id`='$loginid',
                                `status`='$status' 
                                WHERE `doctor_timings_id`='".$_GET['id']."';";
...
if($asd)
{
  ...
  echo "alert('Doctor Timing Updated Successfully');";
  echo 'window.location.href = "view_doctortiming.php";';
  echo '</script>';
}  
else
{ 
